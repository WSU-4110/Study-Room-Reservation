import { NotificationHelper } from "../TS/testing/NotificationHelper";
import type {
	NotificationPriority,
	NotificationSettings,
	NotificationType,
	ReservationNotification,
} from "../TS/testing/NotificationHelper";
...
describe("NotificationHelper", () => {
	...
	describe("validateNotificationSettings", () => {
		...
		it("should return invalid when reminderMinutes array is empty", () => {
			...
			expect(result.isValid).toBe(false);
			expect(result.errors).toContain("reminderMinutes array cannot be empty");
		});
